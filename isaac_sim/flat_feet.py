# Fix feet angle - compensate to be flat
import socket
import json
import time
...
# The toe needs to compensate for the ankle bend to keep feet flat
# If ankle bends 90° back, toe needs to bend forward to compensate
# Toe at -90° should make feet flat when ankle is at 90°
...
joint_config = {
    ...
    "ankle_joint": {"stiff": 20000, "damp": 2000, "target": 90},
    "toe_joint": {"stiff": 10000, "damp": 1000, "target": -90},  # Compensate to flat!
}
...
print("")
print("Ankle: 90° (knee back)")
print("Toe: -90° (compensate for flat feet)")
...
print("Setting up with compensated flat feet...")
